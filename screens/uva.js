...
export default class EdicaoUva extends Component{
    render(){
        return(
            ...
            <ImageBackground source={require('../assets/background.jpg')} style={styles.backgroundImage}>
                <View style={styles.title}>
                    ...
                    <Text style={styles.titleText}>Uva</Text>
                    <Text style={styles.titleText}>Data de vencimento:</Text>
                    <Text style={styles.titleText}>20 de julho de 2022</Text>
                    <Text style={styles.titleText}>Quantidade:</Text>
                    <Text style={styles.titleText}>2 caixas</Text>
                </View>
